...
if not IS_POSTGRES:
    import shutil
    db_source = str(os.environ.get('SANCHAY_DB_PATH', _ROOT / 'sanchay_local.db'))
    DB_PATH = '/tmp/sanchay_local.db'
    if not os.path.exists(DB_PATH) and os.path.exists(db_source):
        try:
